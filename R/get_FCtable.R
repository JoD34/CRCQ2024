...
subset_groups <- function(df, comp){
    list(
        function(df) filter_data(df = df, pattern_1 = 'DMSO.csv', pattern_2 = 'ENZA', invert = TRUE),
        function(df) filter_data(df = df, pattern_1 = 'DMSO.csv', pattern_2 = 'ENZA', invert = FALSE),
        function(df) filter_data(df = df, pattern_1 = 'DMSO_ENZA.csv', pattern_2 = '__DMSO__', invert = TRUE),
        function(df) filter_data(df = df, pattern_1 = paste(comp, collapse = '|'), pattern_2 = '', invert = FALSE)
    )
}
